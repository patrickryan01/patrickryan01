...
**CTO @ Fireball Industries** 🔥 — Somehow still vertical and still shipping code at [fireballz.ai](https://fireballz.ai). Yes, the domain ends in `.ai` because it's 2026 and if your company doesn't have an AI domain you're basically a fax machine. Investors love it. My therapist has concerns. I have White Monsters. We are not the same.

> *"I mass consume White Monsters, mass produce YAML files, and mass convert existential dread into Prometheus alerts. I am the pipeline. The pipeline is me. We have become one."*
...
### 🏗️ **Industrial Dashboard** *(I INVENTED THIS. ME. WITH THESE HANDS.)*
> The industry gave me garbage monitoring tools so I blacked out and built my own. You're welcome.
- Full-stack industrial IoT dashboard for real-time floor monitoring because staring at blinking LEDs on a PLC like it's 1997 was making me feral
...
- **This dashboard has more emotional intelligence than most of my exes**

### 🔥 **Emberburn** *(ALSO MINE. I CAN'T BE STOPPED.)*
...
- Fireballz.ai does AI things. Important things. Revolutionary things. My marketing team wrote that sentence, not me.
- Machine learning models that are learning *something* — the math checks out, my confidence does not
...
- 🔥 **Emberburn** — my second invention, designed to break things so production doesn't. It was born angry and I respect that.
...
*P.S. — If you read this whole thing, you're either a recruiter, deeply bored, or also unhinged. Either way, welcome. You're my people now.*
